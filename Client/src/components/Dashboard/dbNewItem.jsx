...
const DashboardNewItem = () => {
  ...
  const uploadImage = (e) => {
    ...
    const storageRef = ref(storage, `Web_Images/${Date.now()}_${imageFile.name}`)
    ...
    <div className='flex items-center justify-center flex-col pt-6 px-24 w-full'>
      <div className='border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4'>
          ...
          {statuses &&
            statuses?.map((data) => (
              <p
                ...
                className={`px-3 py-2 rounded-md text-xl text-textColor font-semibold cursor-pointer hover:shadow-md border border-gray-200 backdrop-blur-md 
                            ${ data.category === category ? 'bg-red-400 text-white' : 'bg-transparent' }`}
              >
                {data.title}
              </p>
            ))}
                  ...
                  <label>
                    <div className=' flex flex-col items-center justify-center h-full w-full cursor-pointer'>
                      <div style={{
                          ...
                          className='flex flex-col justify-center items-center cursor-pointer h-full w-full text-center'
                      >
        ...
        <motion.button
          ...
          {...buttonClick}
          className='w-9/12 py-2 rounded-md bg-red-400 text-white hover:bg-red-500 cursor-pointer'
        >
          Save
        </motion.button>
