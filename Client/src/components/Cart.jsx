...
const Cart = () => {
  ...
  return (
    <motion.div
      {...slideIn}
      className='fixed z-50 top-0 right-0 w-300 md:w-508 bg-lightOverlay backdrop-blur-md shadow-md h-full overflow-y-auto'
    >
      <div className='w-full flex items-center justify-between py-4 pb-12 px-6'>
        ...
        <motion.i {...buttonClick} className='cursor-pointer'>
          <FaCartArrowDown  className='text-[30px] text-textColor' /> {/* FcClearFilters */}
        </motion.i>
      </div>
      ...
      <div className='flex-1 flex flex-col items-start justify-start rounded-t-3xl bg-zinc-900 h-full py-6  gap-3 relative'>
        {cart && cart?.length > 0 ? (
          <>
            ...
            <div className='bg-zinc-800 rounded-[60px] w-full h-[35%] flex flex-col items-center justify-center px-6 py-6 gap-8'>
              <div className='w-full flex items-center justify-evenly'>
                ...
                <p className='text-3xl text-orange-500 font-semibold flex items-center justify-center gap-1'>
                  <PiCurrencyCircleDollar className='text-white' />
                  {total}
                </p>
              </div>
          ...
          <div className='w-full flex items-center justify-center py-4 pb-12 px-6'>
            <h1 className='text-3xl text-white font-bold'>Empty Cart</h1>
          </div>
        )}
      </div>
    </motion.div>
    ...
    >
      ...
      <div className='flex items-center justify-start gap-1 w-full'>
        ...
        <p className='text-sm flex items-center justify-center gap-1 font-semibold text-red-400 ml-auto'>
          <PiCurrencyCircleDollar className='text-red-400' /> {itemTotal}
        </p>
      </div>
      ...
      <div className='ml-auto flex items-center justify-center gap-3'>
        ...
        <p className='text-lg text-white font-semibold'>{data?.quantity}</p>
        <motion.div
          {...buttonClick}
          className='w-8 h-8 flex items-center justify-center rounded-md drop-shadow-md bg-zinc-900 cursor-pointer'
